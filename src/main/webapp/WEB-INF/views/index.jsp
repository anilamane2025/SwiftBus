...
<body>
	...
	<!-- ================= HERO ================= -->
	<section
		class="hero position-relative text-white text-center d-flex align-items-center justify-content-center"
		style="background: url('assets/images/hero-bus.png') center/cover no-repeat; min-height: 85vh;">
		<div
			class="bg-dark bg-opacity-50 position-absolute top-0 start-0 w-100 h-100"></div>
		<div class="container position-relative">
			<h1 class="display-3  fw-bold mb-3 text-white">Book Your Ride
				Swiftly</h1>
			<p class="lead mb-4">Fast, Easy & Reliable Bus Ticket Booking</p>
			<a href="<c:url value='/booking' />"
				class="btn btn-primary btn-lg radius-12">Book Now</a>
		</div>
	</section>
		...
		<div class="container text-center">
			...
			<div class="row g-4">
				<div class="col-md-4">
					...
					<p class="text-secondary-light">Book tickets in just a few
						clicks without hassle.</p>
				</div>
				<div class="col-md-4">
					<i class="ri-shield-check-line text-success fs-1 mb-3"></i>
					<h5 class="fw-semibold">Safe & Reliable</h5>
					<p class="text-secondary-light">Trusted by thousands of daily
						travelers.</p>
				</div>
				<div class="col-md-4">
					<i class="ri-customer-service-2-line text-warning fs-1 mb-3"></i>
					<h5 class="fw-semibold">24/7 Support</h5>
					<p class="text-secondary-light">We are always here to assist
	...
	<section class="py-80">
		<div class="container">
			<div class="row align-items-center g-5">
				<div class="col-md-6">
					<img src="<c:url value='/assets/images/bus-interior.png' /> "
						alt="Comfortable Travel" class="img-fluid radius-16 shadow">
				</div>
				<div class="col-md-6">
					<h2 class="fw-bold mb-3">Travel in Comfort</h2>
					<p class="text-secondary-light mb-4">Experience luxury seating,
						on-time departures, and the safest journeys with SwiftBus.</p>
					<a href="<c:url value='/about' />"
						class="btn btn-outline-primary radius-12">Learn More</a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="testimonial-slider">
				...
				<div class="p-4">
					<div class="card radius-16 shadow-sm p-4 h-100">
						<p class="text-secondary mb-3">"Booking with SwiftBus was so
							easy! The bus was clean and arrived on time. Highly recommend!"</p>
				...
				<div class="p-4">
					<div class="card radius-16 shadow-sm p-4 h-100">
						<p class="text-secondary mb-3">"I love the comfort of the
							seats and the friendly service. Makes my daily commute
							stress-free."</p>
				...
				<div class="p-4">
					<div class="card radius-16 shadow-sm p-4 h-100">
						<p class="text-secondary mb-3">"Affordable and reliable. I
							never worry about missing my bus with SwiftBus notifications."</p>
	...
	<section class="py-80 bg-primary text-white text-center">
		<div class="container">
			...
			<p class="lead mb-4">Book your tickets now and enjoy a
				hassle-free journey with SwiftBus.</p>
			<a href="<c:url value='/booking' />"
				class="btn btn-light btn-lg radius-12">Get Started</a>
		</div>
	</section>
